...
export const User_post = ({userPosts,setshowbar,showbar,hiddenclass}) => {
  ...
  return (
    <>
    <div className=''>
    <div className="flex flex-wrap z-10  overflow-auto w-[100vw]  md:w-[90vw] lg:w-[900px] bg-transparent md:mb-10">
      ...
      <div className='absolute  h-[100vh] w-[100vw] backdrop-filter backdrop-blur-lg top-0 z-50 display_post flex-col justify-center items-center hidden'>
